...
tag: build
	...
	docker tag udagram-api-feed "${DOCKER_USERNAME}"/udagram-api-user:v1
	docker tag udagram-api-feed "${DOCKER_USERNAME}"/udagram-reverseproxy:v1
	docker tag udagram-api-feed "${DOCKER_USERNAME}"/udagram-frontend:v1
push: tag
